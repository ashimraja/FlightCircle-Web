...
export default function DestinationCard({ city, airport, offer, image }: DestinationCardProps) {
  return (
    <div className={`group relative overflow-hidden rounded-[1.75rem] ${image} p-6 text-white shadow-soft`}>
      <div className="absolute inset-0 bg-black/20 transition group-hover:bg-black/25" />
      <div className="relative space-y-3">
        <p className="text-sm uppercase tracking-[0.24em] text-slate-100/80">{airport}</p>
