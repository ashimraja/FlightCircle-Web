...
const benefits = [
  {
    ...
    description:
      "Simple flight comparison with premium details and fewer distractions. Every flight card is designed for quick decisions.",
  },
  {
    icon: ShieldCheck,
    title: "Confidence-driven choices",
    description:
      "Transparent fares, baggage notes, and refund clarity for every booking. No hidden surprises.",
  },
  {
    icon: CreditCard,
    title: "Ready for next phase",
    description:
      "A polished booking flow built to transition seamlessly into payments. From search to confirmation.",
  },
  {
    icon: Zap,
    title: "Lightning-fast search",
    description:
      "Instant flight filtering with real-time results. Find your perfect flight in seconds.",
  },
  {
    icon: Globe,
    title: "Global coverage",
    description:
      "Access to flights across major routes with trusted airlines and premium service partners.",
  },
  {
    icon: Award,
    title: "Premium experience",
    description:
      "Designed by travelers, for travelers. Every detail reflects quality and user care.",
  },
];
      ...
      <div className="rounded-[1.5rem] border border-slate-200 bg-gradient-to-br from-brand/15 via-white to-slate-100 px-4 py-8 shadow-soft sm:rounded-[2rem] sm:px-6 sm:py-12 lg:px-10 lg:py-16">
        <div className="max-w-3xl space-y-4 sm:space-y-6">
          ...
          <p className="text-sm leading-7 text-slate-600 sm:text-base sm:leading-8">
            Flight Circle is built with intention. Every interaction, every
            design decision, and every feature is crafted to make your flight
            search and booking experience intuitive, transparent, and enjoyable.
          </p>
        </div>
      </div>
      ...
      <section className="space-y-6 sm:space-y-10">
        <div className="space-y-2 text-center">
          ...
          <p className="text-xs text-slate-600 sm:text-sm">
            Six core values that define the Flight Circle experience
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:gap-6 lg:grid-cols-2 lg:items-center">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3 text-xs text-slate-600 sm:space-y-4 sm:text-sm">
              <p>
                Flight Circle is a dedicated booking platform focused on
                clarity, transparency, and thoughtful design for travelers
                between Nepal and Australia and beyond.
              </p>
              <p>
                Every component, every interaction, and every animation is
                intentional. We believe that booking a flight should feel as
                premium as the journey itself.
              </p>
              <p>
                Our team has spent countless hours refining the details—from
                perfect typography hierarchy to smooth transitions—ensuring that
          ...
          <div className="rounded-[1.25rem] border border-slate-200 bg-slate-50 p-4 space-y-3 sm:rounded-[1.75rem] sm:p-6 sm:space-y-4">
            {[
              ...
              <div
                key={item.label}
                className="rounded-2xl bg-white p-3 shadow-sm sm:rounded-3xl sm:p-4"
              >
                <p className="text-xs text-slate-500 sm:text-sm">
                  {item.label}
                </p>
                <p className="mt-1 text-sm font-semibold text-slate-900 sm:mt-2 sm:text-base">
                  {item.value}
                </p>
              </div>
            ))}
